...
for(i in 1:length(cuts)){
  cutpoint <- cuts[i]
  source("code/estimates_for_research/Cutpoint Investigation/cutpoint_estimates_2017_red_snapper.R")
  cut_tibble$PSE[i] <- ty2_pse
  cut_tibble$ty2_est[i] <- ty2_17_rs_total_a 
}

#source("code/estimates_for_research/estimating red snapper total with just intercept sample.R")
ty2_17 <- 254525
se_ty2_17 <- ty2_17*0.142
...
cut_gather %>% 
  ...
  theme(axis.text.y = element_text(size = 15),
        ...
        axis.text.x = element_text(size = 15),
        strip.text = element_text(size = 20))
ggsave("C:/Users/32443181/Box Sync/Research/Dissertation/Thesis/cut-point-vs.jpg",
...
cut_gather %>% 
  ...
  theme(axis.text.y = element_text(size = 15),
        ...
        axis.title.x = element_text(size = 20),
        axis.text.x = element_text(size = 15))
ggsave("C:/Users/32443181/Box Sync/Research/Dissertation/Thesis/cut-point-bias.jpg",
       height=5, width=8.5, units='in', dpi=600)
cut_gather %>% 
  filter(Stat == "bias") %>% 
  ggplot(aes(cutoff,value)) +
  ...
  theme(axis.text.y = element_text(size = 15),
        ...
        axis.title.x = element_text(size = 20),
        axis.text.x = element_text(size = 15))
ggsave("C:/Users/32443181/Box Sync/Research/Dissertation/Thesis/cut-point-bias-no-line.jpg",
       height=5, width=8.5, units='in', dpi=600)
...
cut_gather %>% 
  ...
  theme(axis.text.y = element_text(size = 15),
        ...
        axis.title.x = element_text(size = 20),
        axis.text.x = element_text(size = 15))
ggsave("C:/Users/32443181/Box Sync/Research/Dissertation/Thesis/cut-point-pmse.jpg",
       height=5, width=8.5, units='in', dpi=600)
