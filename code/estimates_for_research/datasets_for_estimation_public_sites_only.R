...
mrip_non_rep <- mrip_all %>% #take out the matches from mrip_all
  anti_join(tidy_all_matches_one_per,by=c("date_time_mrip","ST","wp_int","CLS_ID")) 
...
write_csv(mrip_all_16,"data/mrip_all_16_public.csv")
write_csv(mrip_all_17,"data/mrip_all_17_public.csv")
write_csv(cls_16,"data/cls_16_public.csv")
write_csv(cls_17,"data/cls_17_public.csv")

## Record Linkage with Cut point of 13
...
write_csv(mrip_all_16_2,"data/mrip_all_16_cutoff13_public.csv")
write_csv(mrip_all_17_2,"data/mrip_all_17_cutoff13_public.csv")

## Record Linkage with Cut point of 15
...
write_csv(mrip_all_16_2,"data/mrip_all_16_cutoff15_public.csv")
write_csv(mrip_all_17_2,"data/mrip_all_17_cutoff15_public.csv")
